...
public class PrivateSpecialDAO {

    public static ArrayList<PrivateSpecials> getSpecialsList(int logId, int leagueId) {
        ArrayList<PrivateSpecials> specialsList = new ArrayList<>();
            ...
            if (response != null) {
                ...
                if (specials.length() > 0) {
                    for (int i = 0; i < specials.length(); i++) {
                        ...
                        PrivateSpecials special = new PrivateSpecials(
    ...
    public static boolean updateSpecialsPrediction(ArrayList<PrivateSpecials> specialsList, int leagueId) throws JSONException, IOException {
        JSONObject parentJson = new JSONObject();
        JSONArray specialArray = new JSONArray();

        for (PrivateSpecials s : specialsList) {
    ...
    public static ArrayList<PrivateSpecials> getAllSpecials() {
        ArrayList<PrivateSpecials> specialsList = new ArrayList<>();
        String url = DBConnection.privateSpecials();
